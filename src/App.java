...
/* 
    public static int getPositive(Scanner scanner, String message){
        int number;
        do{//la primera vez no valida la condicion y mientras la condicion se cumple, repite
...
*/
  /*
        metodoBurbujaClase.ordenarAscendente(arreglo);
        metodoBurbujaClase.imprimirArreglo(arreglo);
        metodoBurbujaClase.imprimirArreglo(arreglo);*/

       //mS.ordenarDesSeleccion(arreglo);
       //metodoBurbujaClase.imprimirArreglo(arreglo);

        //mS.ordenarAsdSeleccion(arreglo);
        //metodoBurbujaClase.imprimirArreglo(arreglo);
        ...
        //System.out.println("metodo de insecion");
        //mI.ordenarAsc(arreglo);
        //metodoBurbujaClase.imprimirArreglo(arreglo);
